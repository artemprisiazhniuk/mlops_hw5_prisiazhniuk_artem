...
- склонировать данный репозиторий с помощью `git clone` и зайти в соответствующую папку `cd mlops_hw4_prisiazhniuk_artem`
